...
class JksBots(Bots):
    ...
    def requestLogin(self):
        msg = MessageUser_pb2.GuestLogin()
        msg.device = "bots_test" + str(self._id)
        self.sendMsg(MessageTypeDefine_pb2.MSG_REQUEST_GUEST_CHECK, msg)
